...
|---------|------------|------------------|:--:|:-----------:|:--:|:------:|:---:|:-----:|-------------------|----|
| ID      | id         | INTEGER UNSIGNED | ○  |             |    |        |  ○  |       |                   |    |
| アカウントID | account    | INTEGER UNSIGNED |    | accounts.id | ○  |        |     |       |                   |    |
...
| ID        | id         | INTEGER UNSIGNED | ○  |                   |    |        |  ○  |       |                   |                                               |
| ゲームID     | game       | INTEGER UNSIGNED |    | game_histories.id |    |        |     |       |                   |                                               |
| 死亡プレイヤーID | dead       | INTEGER UNSIGNED |    | accounts.id       | ○  |        |     |       |                   | 死んだプレイヤーのaccounts.id                          |
| 死亡メッセージ   | message    | VARCHAR(100)     |    |                   |    |        |     |       |                   | PlayerDeathEvent::getDeathMessage()を記録        |
| キルプレイヤー   | killer     | INTEGER UNSIGNED |    | accounts.id       |    |        |     |       |                   | 死んだ原因が他のプレイヤーから殺された場合のみ、殺してきたプレイヤーのplayers.id |
| 作成日       | created_at | DATETIME         |    |                   | ○  |        |     |       | CURRENT_TIMESTAMP |                                               |
